      ...
      <div className="flex">
        {movies.map((movie) => (
          <div key={movie.id} className="flex-full min-w-0 relative">
            ...
            <div className="hidden lg:inline absolute mt-0 top-0 z-20 pt-40 xl:pt-52 left-0 lg:mt-40 bg-transparent h-full w-full bg-gradient-to-r from-gray-900/90  to-transparent p-10 space-y-5">
